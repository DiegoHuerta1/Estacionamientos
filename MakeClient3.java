...
public class MakeClient3{
  ...
  public static void main(String[] args){
    ...
    try{
      ...
      System.out.println("El cliente sale del estacionamiento de ciencias");
      serverStub.saleCliente(clientStub);

      // tomar el stub de de salud
      String estacionamientoSalud = "EstacionamientoSalud";
      UdlapNewsEstacionamiento serverStub2 =
      (UdlapNewsEstacionamiento) registry.lookup(estacionamientoSalud);

      // entrar al estacionamiento de salud
      System.out.println("El cliente entra al estacionamiento de salud");
      serverStub2.entraCliente(clientStub);
